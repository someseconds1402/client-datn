...
const getDistributionDataAPI = async(listReceive, listSupport) => {
    try {
        return (await axios.post(PATH_API.BASE_URL + PATH_API.GET_DISTRIBUTION_DATA, { listReceive, listSupport })).data;
    } catch (err) {
        console.log(err);
    }
}
